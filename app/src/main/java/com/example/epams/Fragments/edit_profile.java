...
public class edit_profile extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        frag = inflater.inflate(R.layout.fragment_edit_profile, container, false);
        init();
        return frag ;
    }
            ...
            db.collection("Users").document(curuser.getEmail()).get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                ...
                public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                    if (task.isSuccessful()) {
                        ...
                        first_name.setText(doc.getString("firstName"));
                        last_name.setText(doc.getString("lastName"));
    ...
    private void update_user_details() {
        try {
            ...
            datamap.put("firstName", first_name.getText().toString());
            datamap.put("lastName", last_name.getText().toString());
